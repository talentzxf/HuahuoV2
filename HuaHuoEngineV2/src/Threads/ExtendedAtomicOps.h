...
#   include "Threads/ExtendedAtomicOps-clang-gcc.h"

#elif defined(__x86_64__) || defined(_M_X64)

#   include "Threads/ExtendedAtomicOps-x86-64.h"

#elif defined(__x86__) || defined(__i386__) || defined(_M_IX86)

#   include "Threads/ExtendedAtomicOps-x86.h"

#elif (defined(__arm64__) || defined(__aarch64__)) && (defined(__clang__) || defined(__GNUC__))

#   include "Threads/ExtendedAtomicOps-arm64.h"

#elif defined(_M_ARM64)

#   include "Threads/ExtendedAtomicOps-arm64-windows.h"
...
#   include "Threads/ExtendedAtomicOps-arm.h"
