...
TransformType ComputeTransformType(const Matrix4x4f& matrix, float epsilon = Vector3f::epsilon);
...
//BIND_MANAGED_TYPE_NAME(Matrix4x4f, UnityEngine_Matrix4x4);
//BIND_MANAGED_TYPE_NAME(FrustumPlanes, UnityEngine_FrustumPlanes);
