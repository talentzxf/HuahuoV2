 ...
 */
#if (defined __GNUC__) || (defined __PGI) || (defined __IBMCPP__) || (defined __ARMCC_VERSION) || defined(__ghs__) || defined(__SNC__)
...
#if defined(EIGEN_DONT_USE_RESTRICT_KEYWORD) || defined(__ghs__)
