...
#if defined(__cplusplus)
    __forceinline operator __n32i() const;
#endif
} __n32;

typedef union __declspec(intrin_type) _ADVSIMD_ALIGN (4) __n32i
{
    unsigned __int32    n32_u32[1];
    unsigned __int16    n32_u16[2];
    unsigned __int8     n32_u8[4];
...
#if defined(__cplusplus)
    __forceinline operator __n32() const;
#endif
} __n32i;
...
#if defined(__cplusplus)
    __forceinline operator __n64i() const;
#endif
} __n64;

typedef union __declspec(intrin_type) _ADVSIMD_ALIGN (8) __n64i
{
    unsigned __int64    n64_u64[1];
    unsigned __int32    n64_u32[2];
    unsigned __int16    n64_u16[4];
...
#if defined(__cplusplus)
    __forceinline operator __n64() const;
#endif
} __n64i;
...
#if defined(__cplusplus)
    __forceinline operator __n128i() const;
#endif
} __n128;

typedef union __declspec(intrin_type) _ADVSIMD_ALIGN (16) __n128i
{
    unsigned __int64   n128_u64[2];
    unsigned __int32   n128_u32[4];
    unsigned __int16   n128_u16[8];
...
#if defined(__cplusplus)
    __forceinline operator __n128() const;
    __forceinline __n128i operator=(const __n128&);
#endif
} __n128i;
...
__forceinline __n32::operator __n32i() const
{
    return *reinterpret_cast<const __n32i*>(this);
}

__forceinline __n32i::operator __n32() const
{
    return *reinterpret_cast<const __n32*>(this);
}

__forceinline __n64::operator __n64i() const
{
    return *reinterpret_cast<const __n64i*>(this);
}

__forceinline __n64i::operator __n64() const
{
    return *reinterpret_cast<const __n64*>(this);
}

__forceinline __n128::operator __n128i() const
{
    return *reinterpret_cast<const __n128i*>(this);
}

__forceinline __n128i::operator __n128() const
{
    return *reinterpret_cast<const __n128*>(this);
}

__forceinline __n128i __n128i::operator=(const __n128& rhs)
{
    return *this = *reinterpret_cast<const __n128i*>(&rhs);
}
...
__inline _Post_equal_to_(p) __n64 *__int16ToN64(_In_ int16_t * p)     {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__int32ToN64(_In_ int32_t * p)     {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__int64ToN64(_In_ int64_t * p)     {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__uint8ToN64(_In_ uint8_t * p)     {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__uint16ToN64(_In_ uint16_t * p)   {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__uint32ToN64(_In_ uint32_t * p)   {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__uint64ToN64(_In_ uint64_t * p)   {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__poly8ToN64(_In_ poly8_t * p)     {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__poly16ToN64(_In_ poly16_t * p)   {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n64 *__float32ToN64(_In_ float32_t * p) {
    return (__n64 *)p;
}
__inline _Post_equal_to_(p) __n32 *__float32ToN32(_In_ float32_t * p) {
    return (__n32 *)p;
}

__inline _Post_equal_to_(p) const __n64 *__int8ToN64_c(_In_ const int8_t * p)       {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__int16ToN64_c(_In_ const int16_t * p)     {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__int32ToN64_c(_In_ const int32_t * p)     {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__int64ToN64_c(_In_ const int64_t * p)     {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__uint8ToN64_c(_In_ const uint8_t * p)     {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__uint16ToN64_c(_In_ const uint16_t * p)   {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__uint32ToN64_c(_In_ const uint32_t * p)   {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__uint64ToN64_c(_In_ const uint64_t * p)   {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__poly8ToN64_c(_In_ const poly8_t * p)     {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__poly16ToN64_c(_In_ const poly16_t * p)   {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n64 *__float32ToN64_c(_In_ const float32_t * p) {
    return (const __n64 *)p;
}
__inline _Post_equal_to_(p) const __n32 *__float32ToN32_c(_In_ const float32_t * p) {
    return (const __n32 *)p;
}
