...
#ifndef HUAHUOENGINE_REGISTERRUNTIMEINITIALIZEANDCLEANUP_H
#define HUAHUOENGINE_REGISTERRUNTIMEINITIALIZEANDCLEANUP_H
...
#endif //HUAHUOENGINE_REGISTERRUNTIMEINITIALIZEANDCLEANUP_H
