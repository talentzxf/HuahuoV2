...
#ifndef PERSISTENTMANAGER_TYPEMANAGER_H
#define PERSISTENTMANAGER_TYPEMANAGER_H
...
private:
    ...
    typedef std::unordered_map<PersistentTypeID, TypeCallbackStruct> TypeCallbacks;
...
#endif //PERSISTENTMANAGER_TYPEMANAGER_H
